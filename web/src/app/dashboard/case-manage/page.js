                  ...
                  <CardBody>
                    <div className="flex flex-row justify-between">
                      <div className="w-full grid grid-cols-5 gap-1 text-small ">
                        <CellItemRow title="銀行名" value={item.bank_name} />
                        <CellItemRow title="提携先" value={item.type} />
                        <CellItemRow
                          title="ローン対象"
                        ...
                        />
                        <CellItemRow title="実行日" value={item.excute_date} />

                        <CellItemRow title="邸コード" value={item.house_code} />
